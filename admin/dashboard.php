                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="d-sm-flex align-items-baseline report-summary-header">
                          <h5 class="font-weight-semibold">MIET BR Summary</h5> <span class="ml-auto">Updated Report</span> <button class="btn btn-icons border-0 p-2"><i class="icon-refresh"></i></button>
                        </div>
                      </div>
                    </div>
...
?>
                          ...
                          <a href="manage-class.php"><span class="report-count"> View Section</span></a>
                        </div>
...
$totsubject=$query3->rowCount();
?>
                          <span class="report-title">Total Subjects</span>
                          <h4><?php echo htmlentities($totsubject);?></h4>
...
$totclass=$query1->rowCount();
?>
                          <span class="report-title">Total Section</span>
                          <h4><?php echo htmlentities($totclass);?></h4>
                          <a href="manage-class.php"><span class="report-count"> View Section</span></a>
                        </div>
                        <div class="inner-card-icon bg-success">
